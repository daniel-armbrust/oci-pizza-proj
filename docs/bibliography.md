...
- [Simovic Aleksandar, Stojanovic Slobodan (2019). Serverless Applications with Node.js. Published by Manning Publications](https://amzn.to/3PiitqC)

- [OCI Functions versus AWS Lambda: Comparing cost and value](https://blogs.oracle.com/cloud-infrastructure/post/oci-functions-v-aws-lambda-comparing-cost-value)
